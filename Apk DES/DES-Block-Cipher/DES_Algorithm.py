...
Label1 = Label(T, text="Key", font="Calibri", bg="lightgreen").place(x=60, y=60)
ED_Key = Entry(T, textvariable=mainKey, font="Calibri", width="50").place(x=60, y=100)


Label2 = Label(T, text="The Plain Text", font="Calibri", bg="lightgreen").place(x=140, y=160)
clearBtn1 = Button(T, text="Clear", width="8", font="Calibri", command=clear1).place(x=180, y=310)


Label3 = Label(T, text="The Cipher Text", font="Calibri", bg="lightgreen").place(x=560, y=160)
